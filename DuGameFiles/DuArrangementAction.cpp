...
DuArrangementAction::DuArrangementAction() : DuContainer()
{
    addChild(KeyType,
             ...
             new DuEnum<ARRANGEMENT_EVENTACTION>(ARRANGEMENTEVENTACTION_NONE, NUMERIC_DEFAULT_SIZE, NUM_ARRANGEMENTEVENTACTION, ARRANGEMENTEVENTACTION_NONE)
#else
             new DuNumeric(ARRANGEMENTEVENTACTION_NONE, NUMERIC_DEFAULT_SIZE, NUM_ARRANGEMENTEVENTACTION, ARRANGEMENTEVENTACTION_NONE)
#endif
    );
...
#else
DU_KEY_ACCESSORS_IMPL(DuArrangementAction, Type, Numeric, ARRANGEMENT_EVENTACTION, static_cast<ARRANGEMENT_EVENTACTION>(-1))
#endif
